...
class Queen(Piece):
    def __init__(self, x, y, colour, board):
        ...
        imgPath = 'images/' + colour + '_queen.png'
    ...
    # method to get the possible moves of the queen based on movement rules
    def get_possible_moves(self, board):
        possibleMoves = []
        # all the possible moves of the queen from its position (0, 0)
        vectorMoves = []
        ...
        vectorMoves = [neVectors, seVectors, swVectors, nwVectors,
                      nVectors, wVectors, sVectors, eVectors]
